...
- **Synchronous image generation** — `client.images.generate(prompt=..., model=None, n=None, **kwargs)`
  posts to `POST /v1/images/generations` and returns the finished image(s) inline
